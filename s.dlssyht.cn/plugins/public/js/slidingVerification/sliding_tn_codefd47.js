...
var tncode = {
    ...
    _send_result:function(){
        ...
        re.request('get','dom/verify_check2716.html?username='+user_name+'&timestamp='+timestamp+'&ajax=2&tn_r='+tncode._mark_offset,haddle);
    },
    ...
    refresh:function(){
        ...
        var timestamp = Date.parse(new Date());
        var img_url = "dom/verify_check2716.html?username="+user_name+"&timestamp"+timestamp+"&ajax=1&t="+Math.random();
