...
wsf.picTextList_changePic = function () {
    ...
    $('div.b-listpage-pic-text-list-3, .collect_p').on({
        click: function (ev) {
            ...
            var url = 'dom/user_collect_addf3a8.html?timestamp=' + timestamp;
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        window.location.href = "dom/denglu2716.html?username=" + user_name;
                        return false;
                    } else if (data == 3) {
                        if (is_detail) {
    ...
    a_2: {
        ...
        addDom: function (obj, j) {
            ...
            if (this.typeJ['t_' + j.t]) {
                var domhtml = '<div class="int-add-dom"><div class="bgzz"></div><div class="figcaption"><img src="images/VNew/magnifying_glass_img.html" /></div></div>';
                obj.append(domhtml);
            }
        }
    },
...
wsf.tel_select = function(pro_id, v_id){
    ...
    wsf.f.openWin('选号', 'dom/phone_select2716.html?username=' + user_name + '&pid='+pro_id+'&v='+v, 850, 500);
};
/*注册登录协议窗口*/
...
wsf.pShowGetCoupon = function(){
    ...
    if (pCouponList.length) {
        pCouponList.on('click', '.get-coupon-b', function () {
            ...
            var yes = function ()
            {
                $.getJSON("Ajax/Productfc3b.html?type=11&amp;claim_type=1&amp;username=" + user_name + "&pid=" + pro_id + "&coupon_id=" + id, function (data) {
                    var pdom = null,
                                    ...
                                    (function(){
                                        ...
                                        switch(subItem.type*1){
                                            case 1:
                                                ...
                                                icon = '../xysjs.dlssyht.cn/_nuxt/img/service_qq.f68df07.png'
                                                break;
                                            case 2:
                                                href = 'https://amos.alicdn.com/msg.aw?v=2&uid='+ subItem.value +'&site=cnalichn&s=11&charset=utf-8';
                                                icon = '../xysjs.dlssyht.cn/_nuxt/img/service_aliTM.2133809.png'
                                                break;
                                            case 3:
                                                href = 'skype:'+ subItem.value +'?call';
                                                icon = '../xysjs.dlssyht.cn/_nuxt/img/service_skype.cac0a74.png'
                                                break;
                                        }
                                        console.log()
                                        itemHTML = '<a class="qq-item" href="'+ href +'">\
                                                        <span class="evIcon">\
...
wsf.tj_zhuce = function () {
    window.location.href = "dom/zhuce2716.php?username=" + user_name;
};
/*
    createDate:2017/09/24
    图册模块
        ...
        var albumsCollect = function (obj, allObj) {
                if (!(obj.attr('data-click') * 1)) {
                    ...
                    var t = obj.parent(),
                        ...
                        url = 'dom/user_collect_addf3a8.html?timestamp=' + timestamp,
...
wsf.albumsDataLoad = function (type) {
    ...
    $.post("Ajax/TJIndex2716.html?username=" + user_name, {
        type     : 7,
