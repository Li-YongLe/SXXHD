...
function check_doc_down(file_id,pass_tag){
    if (!pass_tag) {
        window.location = 'dom/down_doc_pass2716.html?username='+user_name+'&file_id='+file_id+'&isnopass=1';
    } else {
...
$(function(){
    ...
    if(!zz_userid || !user_name){
        ...
        $.post("ajax_get_user_info.html", {type:"1",u:time,username:user_name,zz_userid:zz_userid},
...
function param_combination_price() {
    ...
    $.post(
        'Ajax/GuiGe2716.html?username='+ user_name,
